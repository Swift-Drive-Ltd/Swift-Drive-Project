...
{
    // A custom confirmation dialog for instructor delete operations
    public class ConfirmDeleteInstructorDialog : Form
    {
        public ConfirmDeleteInstructorDialog(string instructorName, string instructorDetails)
        {
            InitializeComponent(instructorName, instructorDetails);
        }

        private void InitializeComponent(string instructorName, string instructorDetails)
        {
            // Form setup
            this.Text = "Confirm Instructor Deletion";
            ...
            Label lblInstructorName = new Label
            {
                Text = instructorName,
                Font = new Font("Segoe UI", 12, FontStyle.Bold),
            ...
            detailsPanel.Controls.Add(lblInstructorName);

            // Instructor details in a text box for better formatting
